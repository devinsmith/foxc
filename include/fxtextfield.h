 ...
 *****************************************************************************/
#ifndef FX_TEXTFIELD_H
#define FX_TEXTFIELD_H
...
enum {
  TF_ID_CURSOR_HOME = ID_LAST /*=FXFrame::ID_LAST*/,
  TF_ID_CURSOR_END,
  TF_ID_CURSOR_RIGHT,
  TF_ID_CURSOR_LEFT,
ID_CURSOR_WORD_LEFT,
...
struct dkTextField {
  ...
  struct dstr   *contents;       /* Edited text */
  struct dkFont *font;           /* Text font */
  DKColor        textColor;      /* Text color */
  DKColor        selbackColor;   /* Selected background color */
  DKColor        seltextColor;   /* Selected text color */
  DKColor        cursorColor;    /* Color of the Cursor */
