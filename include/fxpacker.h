...
struct dkPacker {
  ...
  int     padtop;           // Top margin
  int     padbottom;        // Bottom margin
  int     padleft;          // Left margin
  int     padright;         // Right margin
  int     hspacing;         // Horizontal child spacing
  int     vspacing;         // Vertical child spacing
  int     border;           // Border width
};

void dkPackerSetup(struct dkPacker *packer, struct dkWindow *win, int pl, int pr, int pt, int pb, int hs, int vs);
