...
#ifndef FX_COMPOSECONTEXT_H
#define FX_COMPOSECONTEXT_H
...
*/
struct dkComposeContext {
  /* dkComposeContext stuff */
  struct dkWindow *window; /* Window we belong to */
  DKSelector message;      /* Message to send it */
};
