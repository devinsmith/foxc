 ...
 *****************************************************************************/
#ifndef FX_SCROLLBAR_H
#define FX_SCROLLBAR_H
...
struct dkScrollBar {
  ...
  DKColor    hiliteColor;     /* Hightlight color */
  DKColor    shadowColor;     /* Shadow color */
  DKColor    borderColor;     /* Border color */
  DKColor    arrowColor;      /* Arrow color */
  int        dragpoint;       /* Point where grabbed */
  DKuchar    mode;            /* Current mode of control */
};
