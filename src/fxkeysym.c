...
struct CodeMap { DKushort sym; DKushort ucs; };


static struct CodeMap sym2ucs[] = {
...
DKwchar dkkeysym2ucs(DKwchar sym)
{
  int h = ARRAYNUMBER(sym2ucs) - 1, l = 0, m;
...
// Translate X11 keysym to unicode
DKwchar dkucs2keysym(DKwchar ucs) {
  int h = ARRAYNUMBER(ucs2sym) - 1, l = 0, m;
